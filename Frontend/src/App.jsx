...
function App() {
  const [activeTab, setActiveTab] = useState("users"); // "users" | "loans" | "review" | "repayments"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const newUserObj = responseData.user || responseData;
  ...
  return (
    <>
      ...
      <div className="navigation-tabs">
        ...
        <button
          className={`nav-tab-btn ${activeTab === "repayments" ? "active" : ""}`}
      ...
      {activeTab === "users" ? (
        ...
        <main>
          <UpcomingRepayments showNotification={showNotification} />
        </main>
      )}
    </>
  );
